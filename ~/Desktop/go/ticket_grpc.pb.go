...
const (
	...
	TicketService_ViewUsers_FullMethodName      = "/ticket.TicketService/ViewUsers"
...
type TicketServiceClient interface {
	...
	ShowReceipt(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*Receipt, error)
	ViewUsers(ctx context.Context, in *SectionRequest, opts ...grpc.CallOption) (*UserList, error)
...
func (c *ticketServiceClient) ShowReceipt(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*Receipt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Receipt)
...
func (c *ticketServiceClient) ViewUsers(ctx context.Context, in *SectionRequest, opts ...grpc.CallOption) (*UserList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserList)
	err := c.cc.Invoke(ctx, TicketService_ViewUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TicketServiceServer interface {
	...
	ShowReceipt(context.Context, *UserRequest) (*Receipt, error)
	ViewUsers(context.Context, *SectionRequest) (*UserList, error)
...
func (UnimplementedTicketServiceServer) ShowReceipt(context.Context, *UserRequest) (*Receipt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ShowReceipt not implemented")
}
func (UnimplementedTicketServiceServer) ViewUsers(context.Context, *SectionRequest) (*UserList, error) {
...
func _TicketService_ViewUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TicketServiceServer).ViewUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TicketService_ViewUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TicketServiceServer).ViewUsers(ctx, req.(*SectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TicketService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TicketService_ViewUsers_Handler,
		},
		{
